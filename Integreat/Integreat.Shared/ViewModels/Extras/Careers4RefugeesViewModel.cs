...
namespace Integreat.Shared
{
    ...
    public class Careers4RefugeesViewModel : BaseContentViewModel
    {
        ...
        public Careers4RefugeesViewModel(IAnalyticsService analytics, INavigator navigator,
        ...
        private async void OnOfferTapped(object careerOfferObject)
        {
            ...
            if (!(careerOfferObject is CareerOffer careerOffer)) return;
        ...
        {
            // try to cast the object, abort if failed
            if (!(offerObject is CareerOffer careerOffer)) return;
