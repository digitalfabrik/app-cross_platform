    ...
    class PdfWebViewRenderer : WebViewRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<WebView> e)
        {
            ...
            if (e.NewElement != null)
            {
                ...
                {
                    var target = string.Format("https://docs.google.com/gview?embedded=true&url={0}", pdfWebView.Uri);
                ...
                else
                {
                    ...
                    Control.LoadUrl(string.Format("file:///android_asset/web/viewer.html?file={0}", pdfWebView.Uri));
                }
            }
        }
    }
