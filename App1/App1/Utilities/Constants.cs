...
namespace App1.Utilities
{
    ...
    public static class Constants
    {
        ...
        public static string CachedFilePath => PlatformHelper.GetInstance().CachedFilePath;

        public static string DatabaseFilePath => PlatformHelper.GetInstance().DatabasePath;
    }
}
